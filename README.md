...
3. Change all theme file names from including "bondholders_subtheme" to including the machine name of your theme.
4. Run a search and replace throughout the theme files to replace "bondholders_subtheme" with the machine name of your theme.
